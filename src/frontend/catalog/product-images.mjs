...
export const productPhotoCatalog = Object.freeze({
  ...
  bridgestone: entry({
    ...
    galleryImages: [
      ...
      photo("bridgestone-tour-b-a-minus.webp", "브리지스톤 투어B B 실물"),
      photo("bridgestone-e12-a-minus-white.webp", "브리지스톤 E12 화이트 B 실물"),
      photo("bridgestone-e12-a-minus-color.webp", "브리지스톤 E12 컬러 B 실물"),
      photo("bridgestone-general-a-minus.webp", "브리지스톤 일반 B 실물"),
    ],
    rules: [
  ...
  srixon: entry({
    ...
    galleryImages: [
      ...
      photo("srixon-general-a-minus.webp", "스릭슨 일반 B 실물"),
    ],
    rules: [
      rule("srixon-general-a-plus.webp", { grades: ["A+"] }),

...
export const productPhotoCatalog = Object.freeze({
  ...
  srixon: entry({
    ...
    rules: [
      rule("srixon-general-a-plus.webp", { models: ["Z-STAR"], grades: ["A+"] }),
      rule("srixon-general-a.webp", { models: ["Z-STAR"], grades: ["A"] }),
      rule("srixon-general-a-plus.webp", { models: ["Z-STAR 반반", "Q-STAR 반반"], grades: ["A+"] }),
      rule("srixon-general-a.webp", { models: ["Z-STAR 반반", "Q-STAR 반반"], grades: ["A"] }),
